...
clusters_final
```
Note that the second slot *nested* contains information about which clusters are nested in which other clusters (this is visible also from the tree, if rm.COCs = FALSE).
